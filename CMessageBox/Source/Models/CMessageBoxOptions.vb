...
Public Class CMessageBoxOptions
    ...
    ''' </exception>
    Public Property ErrorImage As Image = ImageResources._Error
    ...
    ''' Thrown when the assigned image dimensions are different from 64x64 pixels.
    ''' </exception>
    Public Property SuccessImage As Image = ImageResources.Success
    ...
    ''' Thrown when the assigned image dimensions are different from 64x64 pixels.
    ''' </exception>
    Public Property InformationImage As Image = ImageResources.Information
    ...
    ''' Thrown when the assigned image dimensions are different from 64x64 pixels.
    ''' </exception>
    Public Property WarningImage As Image = ImageResources.Warning
    ...
    ''' Thrown when the assigned image dimensions are different from 64x64 pixels.
    ''' </exception>
    Public Property QuestionImage As Image = ImageResources.Question
    ''' <summary>
    ''' Gets or sets the footer message displayed in the exception details popup.
    ''' </summary>
    Public Property FooterMessageExceptionDetailsPopup As String = "An email was forwarded to technical support containing all details related to the error, including the information required to analyze and diagnose the issue."
End Class