''' <summary>
''' Represents a full DataGridView layout configuration for a specific layout/version.
''' </summary>
''' <remarks>
...
Public Class DataGridViewLayout
    ''' <summary>
    ''' Gets the layout name associated with this layout configuration.
    ''' </summary>
    ...
    ''' </summary>
    ''' <param name="LayoutName">The identifier name for the layout configuration.</param>
    ''' <param name="Version">The schema version of the layout.</param>
    Public Sub New(LayoutName As String, Version As Integer)
    ...
    Public Function Clone() As DataGridViewLayout
        Dim MyClone As New DataGridViewLayout(LayoutName, Version) With {
