...
Public Class DataGridViewContentCopy
    ...
    ''' </summary>
    ''' <value>
    ''' <see langword="True"/> to display both images and text; otherwise, <see langword="False"/> to show text only.
    ''' </value>
    <Category("DataGridViewContentCopy")>
    <Description("Determines whether icons are displayed alongside text in the context menu items.")>
    ...
    ''' </summary>
    ''' <value>
    ''' A <see cref="ContextMenuStrip"/> instance containing copy commands, or <see langword="Nothing"/> to auto-generate a default menu.
    ''' </value>
    <Category("DataGridViewContentCopy")>
    <Description("Defines the context menu displayed when right-clicking a cell. A default menu is created if set to Nothing.")>
    ...
    ''' </summary>
    ''' <value>
    ''' The target <see cref="DataGridView"/> instance to observe for right-click copy actions.
    ''' </value>
    <Category("DataGridViewContentCopy")>
    <Description("Defines the DataGridView control associated with this copy component.")>
    ...
    ''' </summary>
    ''' <value>
    ''' <see langword="True"/> to prepend column header titles before cell values; otherwise, <see langword="False"/>.
    ''' </value>
    <Category("DataGridViewContentCopy")>
    ...
    ''' </summary>
    ''' <value>
    ''' <see langword="True"/> to prepend the column header title before the cell value; otherwise, <see langword="False"/>.
    ''' </value>
    <Category("DataGridViewContentCopy")>
    ...
    ''' </summary>
    ''' <value>
    ''' The text displayed by the copy-cell command. The default value is <c>"Copy Cell"</c>.
    ''' </value>
    <Category("DataGridViewContentCopy")>
    ...
    ''' </summary>
    ''' <value>
    ''' The text displayed by the copy-row command. The default value is <c>"Copy Row"</c>.
    ''' </value>
    <Category("DataGridViewContentCopy")>
    ...
    ''' </summary>
    Public Sub New()
        _ToolStripMenuItemCopyCell = New ToolStripMenuItem() With {.Text = CopyCellButtonText, .DisplayStyle = ToolStripItemDisplayStyle.ImageAndText, .Image = My.Resources.ImageResources.CellCopy}
        _ToolStripMenuItemCopyRow = New ToolStripMenuItem() With {.Text = CopyRowButtonText, .DisplayStyle = ToolStripItemDisplayStyle.ImageAndText, .Image = My.Resources.ImageResources.RowCopy}
