        ...
        If DesignMode AndAlso Site IsNot Nothing Then
            ...
            If _DesignerHost IsNot Nothing Then
                ...
                If designer IsNot Nothing Then
                    ...
                    designer.ActionLists.Add(New QueriedBoxDesignerActionList(designer, actions))
                End If
            End If
        End If
    End Sub
            ...
            If QueryEnabled Then
                ...
                If Parent IsNot Nothing Then
                    If DropDownResultsForm Is Nothing Then
                        DropDownResultsForm = New QueriedBoxDropDownResults(Me)
                        CType(DropDownResultsForm, QueriedBoxDropDownResults).Textbox = Me
