...
''' <summary>
''' Provides design-time behavior for the <see cref="CurrencyBox"/> control.
''' </summary>
''' <remarks>
...
''' </remarks>
Public Class CurrencyBoxControlDesigner
    ...
    Public Overrides ReadOnly Property SelectionRules As SelectionRules
        Get
            ...
            Dim Box As CurrencyBox = TryCast(Control, CurrencyBox)
