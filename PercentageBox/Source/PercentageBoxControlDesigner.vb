...
''' <summary>
''' Provides design-time behavior for the <see cref="PercentageBox"/> control.
''' </summary>
''' <remarks>
...
''' </remarks>
Public Class PercentageBoxControlDesigner
    ...
    Public Overrides ReadOnly Property SelectionRules As SelectionRules
        Get
            ...
            Dim Box As PercentageBox = TryCast(Control, PercentageBox)
