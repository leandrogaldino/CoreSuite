...
Public Class Form1
    Private Async Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim Service As New FirebaseService("AIzaSyB5UJrI6iKNmc0GVzvAvA_k82y3HF6RNzQ", "manager-mobile-12764271000100", "manager-mobile-12764271000100.firebasestorage.app")
