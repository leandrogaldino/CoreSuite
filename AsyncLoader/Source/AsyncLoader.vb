...
Public Class AsyncLoader
    ...
    Public Async Function Start(Optional Delay As Integer = 1000) As Task
        ...
        Dim ParentControls As New List(Of Control)
        For Each ControlItem As Control In ControlHelper.GetAllControls(Container, False)
            ParentControls.Add(ControlItem)
        Next
        If CoverParent Then
            For Each ControlItem As Control In ParentControls
                _ControlsState(ControlItem) = ControlItem.Visible
            Next
            For Each ControlItem As Control In ParentControls
        ...
        Else
            For Each ControlItem As Control In ParentControls
                _ControlsState(ControlItem) = ControlItem.Enabled
            Next
            For Each ControlItem As Control In ParentControls
